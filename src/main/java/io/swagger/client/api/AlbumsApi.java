...
public class AlbumsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getNewReleasesCall(String country, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getNewReleasesValidateBeforeCall(String country, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getNewReleasesCall(country, limit, offset, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse20010 getNewReleases(String country, Integer limit, Integer offset) throws ApiException {
        ApiResponse<InlineResponse20010> resp = getNewReleasesWithHttpInfo(country, limit, offset);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20010> getNewReleasesWithHttpInfo(String country, Integer limit, Integer offset) throws ApiException {
        com.squareup.okhttp.Call call = getNewReleasesValidateBeforeCall(country, limit, offset, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getNewReleasesAsync(String country, Integer limit, Integer offset, final ApiCallback<InlineResponse20010> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getNewReleasesValidateBeforeCall(country, limit, offset, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse20010>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
