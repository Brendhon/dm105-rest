...
public class PlaylistsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getFeaturedPlaylistsCall(String country, String locale, String timestamp, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeaturedPlaylistsValidateBeforeCall(String country, String locale, String timestamp, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getFeaturedPlaylistsCall(country, locale, timestamp, limit, offset, progressListener, progressRequestListener);
        return call;
    ...
    public PagingFeaturedPlaylistObject getFeaturedPlaylists(String country, String locale, String timestamp, Integer limit, Integer offset) throws ApiException {
        ApiResponse<PagingFeaturedPlaylistObject> resp = getFeaturedPlaylistsWithHttpInfo(country, locale, timestamp, limit, offset);
        return resp.getData();
    }
    ...
    public ApiResponse<PagingFeaturedPlaylistObject> getFeaturedPlaylistsWithHttpInfo(String country, String locale, String timestamp, Integer limit, Integer offset) throws ApiException {
        com.squareup.okhttp.Call call = getFeaturedPlaylistsValidateBeforeCall(country, locale, timestamp, limit, offset, null, null);
        Type localVarReturnType = new TypeToken<PagingFeaturedPlaylistObject>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getFeaturedPlaylistsAsync(String country, String locale, String timestamp, Integer limit, Integer offset, final ApiCallback<PagingFeaturedPlaylistObject> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getFeaturedPlaylistsValidateBeforeCall(country, locale, timestamp, limit, offset, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagingFeaturedPlaylistObject>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
