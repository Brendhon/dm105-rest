...
public class ErrorObject {
   ...
   * @return status
  **/
  @Schema(required = true, description = "The HTTP status code (also returned in the response header; see [Response Status Codes](/documentation/web-api/concepts/api-calls#response-status-codes) for more information). ")
   ...
   * @return message
  **/
  @Schema(required = true, description = "A short description of the cause of the error. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, errorObject.status) &&
