...
public class CategoryObject {
   ...
   * @return href
  **/
  @Schema(required = true, description = "A link to the Web API endpoint returning full details of the category. ")
   ...
   * @return icons
  **/
  @Schema(required = true, description = "The category icon, in various sizes. ")
   ...
   * @return id
  **/
  @Schema(example = "equal", required = true, description = "The [Spotify category ID](/documentation/web-api/concepts/spotify-uris-ids) of the category. ")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @Schema(example = "EQUAL", required = true, description = "The name of the category. ")
