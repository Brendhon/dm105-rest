...
public class EpisodeBase {
  ...
  **/
   ...
   * @return releaseDate
  **/
  @Schema(example = "1981-12-15", required = true, description = "The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. ")
  ...
  **/
   ...
   * @return resumePoint
  **/
  @Schema(required = true, description = "The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. ")
