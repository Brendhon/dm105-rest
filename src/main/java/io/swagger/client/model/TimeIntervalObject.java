...
public class TimeIntervalObject {
   ...
   * @return start
  **/
  @Schema(example = "0.49567", description = "The starting point (in seconds) of the time interval.")
   ...
   * @return duration
  **/
  @Schema(example = "2.18749", description = "The duration (in seconds) of the time interval.")
   ...
   * @return confidence
  **/
  @Schema(example = "0.925", description = "The confidence, from 0.0 to 1.0, of the reliability of the interval.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.start, timeIntervalObject.start) &&
        Objects.equals(this.duration, timeIntervalObject.duration) &&
        Objects.equals(this.confidence, timeIntervalObject.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(start, duration, confidence);
  }
