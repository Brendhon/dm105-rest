...
public class ChaptersApiTest {
     ...
     */
    @Test
    public void getAChapterTest() throws Exception {
        String id = null;
        String market = null;
     ...
     */
    @Test
    public void getSeveralChaptersTest() throws Exception {
        String ids = null;
        String market = null;
        InlineResponse2006 response = api.getSeveralChapters(ids, market);
